...
////// Emissive:
                ...
                return fixed4(finalColor,(((lerp(node_4569,1.0,_rim_Alpha)*i.vertexColor.a)+node_3313)*step((1.0 - saturate(node_6654)),0.5)*_Alpha*_blendTex_var.a));
            }
            ENDCG
        }
    }
