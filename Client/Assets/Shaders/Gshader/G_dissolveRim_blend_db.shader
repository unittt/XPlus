...
////// Emissive:
                ...
                float node_4569 = saturate((pow(1.0-max(0,dot(normalDirection, viewDirection)),_rimedge_Power)*_rim_Power));
                ...
                float3 emissive = lerp(saturate(((_blendTex_var.rgb*_blendTex_Color.rgb*_blendTex_var.a*_blendTex_Power)+lerp(_ColorIn.rgb,_ColorOut.rgb,node_4569))),_dissEdge_Color.rgb,node_3313);
