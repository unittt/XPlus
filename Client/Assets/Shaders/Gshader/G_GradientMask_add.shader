...
////// Emissive:
                ...
                float3 emissive = (lerp((_MainColor.rgb*_MainTex_var.rgb),(_MainTex_var.rgb*_InColor.rgb),isFrontFace)*i.vertexColor.rgb*_MainTex_Power*lerp( (i.vertexColor.a*node_3596), node_3596, _particle_alpha ));
