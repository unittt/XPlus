...
Shader "Baoyu/Skybox/2Layers-Scroll" {
Properties {
	...
	_MultipleFactor ("Layer Multiplier", Float) = 0.5
}
...
SubShader {
	...
	Pass {
		...
		v2f vert (appdata_base v)
		{
			...
			o.color = fixed4(_MultipleFactor, _MultipleFactor, _MultipleFactor, _MultipleFactor);
