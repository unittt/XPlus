...
////// Emissive:
                ...
                return fixed4(finalColor,(node_7263*(_tex_var.a*i.vertexColor.a*_color.a)));
            }
            ENDCG
        }
    }
