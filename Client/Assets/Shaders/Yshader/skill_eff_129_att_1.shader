...
////// Emissive:
                ...
                float2 node_312 = (i.uv0+node_6613.g*float2(0.1,0.1));
                float4 _node_8910_var = tex2D(_node_8910,TRANSFORM_TEX(node_312, _node_8910));
                float2 node_2730 = (i.uv0+node_6613.g*float2(-0.2,-0.2));
                ...
                return fixed4(finalColor,(_tex_var.a*i.vertexColor.a));
            }
            ENDCG
        }
    }
