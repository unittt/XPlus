...
////// Emissive:
                ...
                float3 emissive = (_tex_var.rgb*i.vertexColor.rgb*_color.rgb*_ZT);
                float3 finalColor = emissive;
                return fixed4(finalColor,(_tex_var.a*i.vertexColor.a*_color.a));
            }
            ENDCG
        }
    }
