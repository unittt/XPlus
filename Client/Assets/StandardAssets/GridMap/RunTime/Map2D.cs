...
namespace GameScripts.RunTime.Map
{
    ...
    {
        public static Map2D CurrentMap { get; private set; }
        ...
        public void LoadAsync(int mapid, Vector3 pos)
        {
            mapGo = gameObject;
            mapTrans = transform;
            this.mapId = mapid;
        ...
        {
            double key = posArray[0] + posArray[1] * Math.Pow(10.0, 2.0) + posArray[2] * Math.Pow(10.0, 4.0) +
                         posArray[3] * Math.Pow(10.0, 6.0) + mapId * Math.Pow(10.0, 8.0);
            return key;
        }
