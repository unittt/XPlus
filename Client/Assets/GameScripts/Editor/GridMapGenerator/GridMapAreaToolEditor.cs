...
namespace GameScripts.Editor.GridMapGenerator
{
    ...
    public class GridMapAreaToolEditor : UnityEditor.Editor
    {
        ...
        {
            tileMap.textAssetData =
                EditorGUILayout.ObjectField("TextAsset:", tileMap.textAssetData, typeof(TextAsset), false) as TextAsset;
        ...
        private void OnSceneGUI()
        {
            ...
            {
                bool ctrlKeyDown = (Application.platform == RuntimePlatform.OSXEditor)
        ...
        private void DrawToolbar()
        {
            ...
            // Brush modes
            if (HiliteBtn(null, brushMode == BrushMode.Brush0, GridMapAreaTool.ColorChannnel[(int)BrushMode.Brush0],
                    "Brush0"))
                brushMode = BrushMode.Brush0;
            GUILayout.Space(10);

            if (HiliteBtn(null, brushMode == BrushMode.Brush1, GridMapAreaTool.ColorChannnel[(int)BrushMode.Brush1],
                    "Brush1"))
                brushMode = BrushMode.Brush1;
            GUILayout.Space(10);

            if (HiliteBtn(null, brushMode == BrushMode.Brush2, GridMapAreaTool.ColorChannnel[(int)BrushMode.Brush2],
                    "Brush2"))
                brushMode = BrushMode.Brush2;
            GUILayout.Space(10);

            if (HiliteBtn(null, brushMode == BrushMode.Brush3, GridMapAreaTool.ColorChannnel[(int)BrushMode.Brush3],
                    "Brush3"))
                brushMode = BrushMode.Brush3;

            GUILayout.Space(10);
            if (HiliteBtn(null, brushMode == BrushMode.Brush4, GridMapAreaTool.ColorChannnel[(int)BrushMode.Brush4],
                    "Brush4"))
        ...
        void DrawOutline()
        {
            ...
            Vector3 p1 = new Vector3(p0.x + tileMap.nodeSize * tileMap.Width, p0.y + tileMap.nodeSize * tileMap.Height,
                0);
