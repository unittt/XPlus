...
public class PrefabLightmapData : MonoBehaviour
{
    ...
    static void GenerateLightmapInfo()
    {
        ...
        foreach (var instance in prefabs)
        {
            ...
            var targetPrefab = UnityEditor.PrefabUtility.GetCorrespondingObjectFromSource(gameObject);
            if (targetPrefab != null)
            {
                UnityEditor.PrefabUtility.SaveAsPrefabAssetAndConnect(gameObject, AssetDatabase.GetAssetPath(targetPrefab), InteractionMode.UserAction);
            }
        }
    }
