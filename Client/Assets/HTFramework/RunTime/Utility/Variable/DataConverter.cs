...
namespace  HT.Framework
{
    public static class DataConverter
    {
        ...
        public static bool ToBoolean(string value)
        {
            try
            {
                return !string.IsNullOrEmpty(value) && BitConverter.ToBoolean(Convert.FromBase64String(value), 0);
            }
            catch (Exception)
            {
                return false;
        ...
        public static float ToSingle(string value)
        {
            try
            {
                return string.IsNullOrEmpty(value) ? 0f : BitConverter.ToSingle(Convert.FromBase64String(value), 0);
            }
            catch (Exception)
            {
                return 0f;
        ...
        public static int ToInt32(string value)
        {
            try
            {
                return string.IsNullOrEmpty(value) ? 0 : BitConverter.ToInt32(Convert.FromBase64String(value), 0);
            }
            catch (Exception)
            {
                return 0;
