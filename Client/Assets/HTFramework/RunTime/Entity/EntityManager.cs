...
namespace HT.Framework
{
    ...
    public sealed class EntityManager : InternalModuleBase<IEntityHelper>
    {
        ...
        {
            set => _helper.IsHideAll = value;
            get => _helper.IsHideAll;
        }
        ...
        public async UniTask<T> CreateEntity<T>(string entityName = "<None>", HTFAction<float> onLoading = null) where T : EntityLogicBase
        {
            return await _helper.CreateEntity<T>(typeof(T), entityName, onLoading);
        }
        /// <summary>
        /// 创建实体
        /// </summary>
        ...
        /// <param name="onLoading">创建实体过程进度回调</param>
        /// <returns>加载协程</returns>
        public async UniTask<EntityLogicBase> CreateEntity(Type type, string entityName = "<None>", HTFAction<float> onLoading = null)
        {
            return await _helper.CreateEntity<EntityLogicBase>(type, entityName, onLoading);
        }
        /// <summary>
        /// 销毁实体
        /// </summary>
