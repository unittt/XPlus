...
namespace HT.Framework
{
    ...
    public sealed class ResourceManager : InternalModuleBase<IResourceHelper>
    {
        ...
        /// 编辑器运行时构建模式
        /// </summary>
        [SerializeField] internal EDefaultBuildPipeline BuildPipeline = EDefaultBuildPipeline.BuiltinBuildPipeline;
        /// <summary>
        ...
        /// <returns></returns>
        public async UniTask<Dictionary<string, T>> LoadAssetByTag<T>(string tag,bool isAddress = true) where T : Object
        {
        ...
        /// <param name="isAddress">是否为可寻址路径</param>
        /// <returns></returns>
        public async UniTask<Dictionary<string, string>> LoadRawFileTextByTag<T>(string tag, bool isAddress = true)
        {
        ...
        /// <param name="isAddress">是否为可寻址路径</param>
        /// <returns></returns>
        public async UniTask<Dictionary<string, byte[]>> LoadRawFileDataByTag(string tag, bool isAddress = true)
        {
        ...
        {
            return await _helper.LoadSceneAsync(location, onLoading,sceneMode, suspendLoad);
        }
